...
import Logo from "/RescueNetLogo.png";
...
const About = () => {
  return (
    <div className="mx-2">
        ...
        <div className="flex flex-col sm:flex-row md:mt-10 h-full">
          <div className="w-full sm:w-1/2 p-6 sm:p-8">
            <div className="rounded-lg h-full">
              <h2 className="text-3xl text-green-700 text-center md:text-wrap md:text-5xl font-bold my-4">
                RescueNet:Comprehensive
                <br />
                <span className="text-green-500">Disaster</span>
                <br />
                Management Solution
              </h2>
            </div>
          ...
          <div className="w-full sm:w-1/2 sm:p-8 flex flex-col justify-center items-center text-2xl">
            <p className="text-center mb-5 mx-3">
              Stay safe, informed, and supported during disaster with the power
              of the RescueNet.
            </p>
      ...
      <div className="flex flex-col p-10 bg-green-200">
        {/* second section */}
          ...
          <div className="w-full sm:w-1/2 p-6 sm:p-8 h-full lg:text-xl">
            <div className="rounded-lg py-8 md:p-0 h-full mt-2">
              ...
              <p className="lg:text-xl mb-4">
                Be the first to know when disaster strikes with our instant
                alert, future, dot, stay informed and take action to keep
                ...
                <div className="flex mb-4">
                  <div className="w-1/2 pr-2">
                    ...
                    <p className="text-md mb-2">
                      Receive real-time notifications about approaching
                      disasters and take necessary precautions
                    </p>
                  </div>
        ...
        <div className="flex flex-col sm:flex-row">
          ...
          <div className="w-full sm:w-1/2 p-6 sm:p-8 h-full">
            <div className="rounded-lg py-8 h-full">
              ...
              <p className="text-lg">
                The RescueNet provides a digital meeting place where community
                members and emergency responders can easily share information,
                coordinate efforts, and work together to ensure an effective
                emergency response.
              </p>
            </div>
            <div className="flex flex-col">
      ...
      <div className="flex flex-col p-10">
        <div className="flex flex-col sm:flex-row">
          <div className="w-full sm:w-1/2 p-6 sm:p-8 h-full">
            <div className="rounded-lg py-8 h-full">
              <p className="mb-4 text-2xl font-extrabold">
                Organizing Emergency Supplies and Shelters for Effective
                Disaster Management
              </p>
              <p className="text-lg mb-4">
                The RescueNet provides a comprehensive resource management
                system that ensures efficient organization of emergency supplies
                and shelters. With our platform, you can easily and manage
                essential resources, making disaster management more effective
                and streamlined.
              </p>
              <div className="flex flex-col">
                <div className="flex sm:flex-row">
      ...
      <div className="flex flex-col justify-content-center items-center w-full bg-green-200 p-5">
        ...
        <button
          className="bg-white rounded-2 text-black py-2 px-4 flex items-center border-2 hover:bg-green-950 hover:text-white transition-colors duration-300"
      ...
      <div className="flex flex-col sm:flex-row h-full p-10">
        <div className="w-full sm:w-1/2 p-6 sm:p-8">
          <div className="rounded-lg py-8 h-full text-center">
      ...
      <footer className="mt-10 bg-gray-200 flex flex-col md:flex-row items-center md:justify-between">
        <div className="p-6 sm:p-8 hidden sm:block">
          {/* <img src="/RescueNet3.png" alt="logo" className="h-16" /> */}
          <img src={Logo} alt="Logo" className="h-16 ml-10 " />
        </div>
